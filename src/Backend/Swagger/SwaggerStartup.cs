...
namespace MyFreelanceGigs.Swagger;
...
public static class SwaggerStartup
{
    ...
    private class GlobalErrorHandlingResponseTypeFilter : IOperationFilter
    {
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            {
                context.SchemaGenerator.GenerateSchema(typeof(ErrorResult), context.SchemaRepository);
                schema = context.SchemaRepository.Schemas[nameof(ErrorResult)];
            }
